...
class ServerAPI{
     ...
     * @param string $format
     */
    public function __construct($appKey,$appSecret, $userid,$format = 'json'){
        $this->appKey = $appKey;
     ...
     * @return json|xml
     */
    public function sendTxtMessage($toUserId, $content, $pushContent = '')
    {
        return $this->messagePublish($this->userid, $toUserId, 'RC:TxtMsg', $content, $pushContent);
    }
     ...
     * @return json|xml
     */
    public function sendCmdMessage($toUserId, $content, $pushContent = '')
    {
